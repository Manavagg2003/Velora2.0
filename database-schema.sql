...
/*
  IMPORTANT: This migration creates the complete database schema for Velora.
  Run this ONCE in your Supabase project's SQL Editor.

  Tables Created:
  1. profiles - User profiles with coin balance
  2. recipe_cache - Stored recipes
  3. saved_recipes - User favorites
